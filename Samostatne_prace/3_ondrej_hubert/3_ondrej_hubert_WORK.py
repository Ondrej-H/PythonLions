...
def najdi_spolecny_znak(retezec1, retezec2):
...
for batoh in seznam_batohu:
    ...
    for prihradka_1, prihradka_2 in seznam_batohu:
        spolecny_znak = najdi_spolecny_znak(prihradka_1, prihradka_2)
        spolecne_druhy.append(spolecny_znak)
...
print(f"Všechny společné předměty: {spolecne_predmety}")
...
for item in spolecne_predmety:
    if item not in spolecne_druhy:      # CHYBA - 4. a 10. batoh jsou stejné, takže se vypisuje pouze 9 prvků namísto deseti
