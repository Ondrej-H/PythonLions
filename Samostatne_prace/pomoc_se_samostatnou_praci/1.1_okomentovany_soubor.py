...
print("-" * 50)
#!!! zde chybí nadpis programu dle zadání, stačí doplnit takto:
#!!!print("ZJISTÍ NEJČATĚJŠÍ JMÉNA V SEZNAMU")
#!!!print("-" * 50)
...
for i in range (pocet_pokusu, 0, -1):
    zadane_heslo = input(f"Zadej heslo pro pokračování: ")      #!!! f string je zde zbytečný, protože ve stringu (řetězci) nepoužíváte žádné složené závorky - stačí smazat f ze začátku stringu

# Zkontroluje správnost hesla a vypíše hlášku
#!!!if zadane_heslo == "konec":
#!!!    print("Program byl ukončený.")
#!!!    exit()
    if zadane_heslo == spravne_heslo:   # !!! a zde ideálně dát elif namísto if
