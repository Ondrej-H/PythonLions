...
muj_ucet = BankovniUcet("běžný", "Jan Novák", 5000)
#goguv_ucet = BankovniUcet("spořící", "Gogo", 8000)

# vypíše zůstatek, majitele a typ účtu
print("Vytvořili jsme bankovní účet.")
print(f"Zůstatek:   {muj_ucet.zustatek}")
print(f"Majitel:    {muj_ucet.majitel}")
print(f"Typ účtu:   {muj_ucet.nazev}")
print(f"Banka:      {muj_ucet.banka}")
#print(f"Gogův zůstatek: {goguv_ucet.zustatek}")

print()

ucet_2 = BankovniUcet("spořící", "Tomáš Svoboda", 20000)
